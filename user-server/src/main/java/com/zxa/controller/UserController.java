...
public class UserController {
    ...
    private final int WEB_SESSION_TIME=10;
    @Value("${web.session.domain:localhost}")
    private final String WEB_SESSION_DOMAIN="";
    ...
    public ReturnEntity userLogin(@Valid LoginParameter loginParameter, BindingResult bindingResult, HttpServletResponse response){
        ...
        /**设置cookie*/
        this.setCookie(response,sessionId,user.getUserName());
        return ReturnEntity.success();
    }

    private void setCookie(HttpServletResponse response,String sessionId,String userName){
